    ...
    if ext == ".dds":
      if scriptJustStarted == True:
        ...
        while n < repeat:
          ...
          if (highestNumber != 0 and inputCopies == "1") or (inputCopies == "2"):
            ...
            if highestNumber == 0 and inputCopies == "2":
            ...
            if skipConverting == False:
              ...
              # checking if output file already exists, in which case check how to proceed
              if (os.path.exists(outputfilefullpath) and proceedInput != "sa" and proceedInput != "oa"):
                  proceedInput = proceedCheck()
              # if output file doesn't exist, or it exists but has been chosen to be overwritten, proceed with converting the file now
              if (os.path.exists(outputfilefullpath) and proceedInput != "s" and proceedInput != "sa") or (os.path.exists(outputfilefullpath) == False):
